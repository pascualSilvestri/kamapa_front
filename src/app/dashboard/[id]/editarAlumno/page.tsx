...
import {
  autorizeNivel,
  autorizeRol,
} from "../../../../utils/autorizacionPorRoles";
...
const EditarAlumnoPage: React.FC<EditarAlumnoPageProps> = ({ params }) => {
  ...
  const handleConfirmSave = async () => {
    try {
      const response = await fetch(
        `${Environment.getEndPoint(Environment.endPoint.updateUsuarioById)}${
          selectedAlumno?.id
        }`,
        {
          method: "PUT",
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        ...
        <Modal.Body>
          {selectedAlumno && (
            <>
              <p>
                <strong>Legajo:</strong> {selectedAlumno.legajo}
              </p>
              <p>
                <strong>Fecha de ingreso:</strong>{" "}
                {new Date(selectedAlumno.fecha_ingreso).toLocaleDateString()}
              </p>
              <p>
                <strong>Fecha de egreso:</strong>{" "}
                {selectedAlumno.fecha_egreso
                  ? new Date(selectedAlumno.fecha_egreso).toLocaleDateString()
                  : "N/A"}
              </p>
              <p>
              ...
              <p>
                ...
                {selectedAlumno.domicilioUsuario
                  ? selectedAlumno.domicilioUsuario.localidad
                  : "No disponible"}
              </p>
              <p>
                <strong>Barrio:</strong>{" "}
                {selectedAlumno.domicilioUsuario
                  ? selectedAlumno.domicilioUsuario.barrio
                  : "No disponible"}
              </p>
              <p>
                <strong>Calle:</strong>{" "}
                {selectedAlumno.domicilioUsuario
                  ? selectedAlumno.domicilioUsuario.calle
                  : "No disponible"}
              </p>
              <p>
                <strong>Número:</strong>{" "}
                {selectedAlumno.domicilioUsuario
                  ? selectedAlumno.domicilioUsuario.numero
                  : "No disponible"}
              </p>
            </>
          )}
            ...
            <Form>
              <Form.Group controlId="formLegajo" className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEditedAlumno({ ...editedAlumno, legajo: e.target.value })
                  }
                />
              </Form.Group>
              <Form.Group controlId="formNombre" className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEditedAlumno({ ...editedAlumno, nombre: e.target.value })
                  }
                />
              </Form.Group>
              ...
              <Form.Group controlId="formDni" className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEditedAlumno({ ...editedAlumno, dni: e.target.value })
                  }
                />
              </Form.Group>
              ...
              <Form.Group controlId="formCuil" className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEditedAlumno({ ...editedAlumno, cuil: e.target.value })
                  }
                />
              </Form.Group>
              ...
              <Form.Group controlId="formEmail" className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEditedAlumno({ ...editedAlumno, email: e.target.value })
                  }
                />
              </Form.Group>
